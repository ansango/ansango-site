...
relatedPosts:
  ...
  postTwo: content/posts/rust/crear-un-nuevo-proyecto-en-rust.mdx
featured: false
draft: false
...
Entonces, en lugar de hacer que println! utilice la función get\_version() para imprimir la versión, haremos que utilice nuestra variable:
...
Podemos mejorar esto dejando que Rust infiera el tipo de the\_version:
