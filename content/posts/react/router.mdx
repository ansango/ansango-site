---
title: React Router
summary: React Router es la librería que nos permite navegar entre rutas en una aplicación en React.
category: react
tags:
  options:
    - react
...
relatedPosts:
  ...
  postTwo: content/posts/react/backend.mdx
  postThree: content/posts/react/conceptos-avanzados.mdx
publishedAt: "2021-08-07T22:00:00.000Z"
---

Para instalarla ejecutamos lo siguiente en terminal:
...
Puedes continuar leyendo el siguiente capítulo sobre [Trabajar con backend en React](/blog/react/backend), volver al capítulo anterior de [Context API](/blog/react/context-api), o volver al [Índice](/blog/react/indice).
