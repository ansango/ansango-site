---
title: Backend y debug en React
summary: >
  Las formas más habituales de comunicarnos con backend en React son axios o 
  fetch. Tanto axios como fetch están basados en promesas.
category: react
tags:
  options:
    - react
...
featured: false
relatedPosts:
  postOne: content/posts/react/indice.mdx
  postTwo: content/posts/react/context-devtool.mdx
  postThree: content/posts/react/router.mdx
publishedAt: '2021-08-08T22:00:00.000Z'
---
...
> Puedes leer una guía completa acerca de `fetch API` [aquí](/blog/javascript/fetch-api "")
...
* **React Developer Tools**: podemos depurar nuestra aplicación en React con las Developer Tools provistas para [Chrome](https://chrome.google.com/webstore/detail/react-developer-tools/fmkadmapgofadopljbjfkapdkoienihi?hl=en "") y [Firefox](https://addons.mozilla.org/en-US/firefox/addon/react-devtools/ "").
* **Servidor mock**: existen varias opciones, pero podemos utilizar [`dyson`](https://github.com/webpro/dyson ""), que nos da un servidor mock bastante completo.
...
Congrats! 🎊 has llegado al final de esta guía, puedes volver al capítulo anterior de [React Router](/blog/react/router ""), o volver al [Índice](/blog/react/indice "").
