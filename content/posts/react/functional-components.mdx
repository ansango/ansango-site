---
title: Functional Components ⚛️
summary: 'En este capítulo vamos a hablar sobre los componentes función de React. '
category: react
tags:
  options:
    - react
...
relatedPosts:
  ...
  postTwo: content/posts/react/intro.mdx
  postThree: content/posts/react/hooks.mdx
draft: false
featured: false
publishedAt: '2021-08-02T22:00:00.000Z'
---
...
Puedes continuar leyendo el siguiente capítulo sobre [Class components](/blog/react/class-components ""), volver al capítulo anterior de [Introducción](/blog/react/intro ""), o volver al [Índice](/blog/react/indice "").
