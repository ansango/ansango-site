...
summary: En esta entrada vamos a hablar sobre los componentes de clase en React, diferencias con los componentes función y ciclos de vida del componente. Actualmente se trabaja más con functional components, pero los class components siguen siendo utilizables y en algunos casos pueden resultar más fáciles de usar.
category: react
tags:
  options:
    - react
