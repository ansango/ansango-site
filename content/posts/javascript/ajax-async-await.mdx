...
summary: >-
  async/await es una característica bastante nueva. Fue añadida en la
  especificación ES2017 hace 4 años más o menos y ahora está disponible de forma
  nativa en la mayoría de los navegadores modernos. 
category: javascript
tags:
  options:
    - javascript
