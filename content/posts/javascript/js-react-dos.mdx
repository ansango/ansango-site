...
summary: Segunda parte del resumen de las mejoras de ES6 más útiles para React
category: javascript
tags:
  options:
    - react
    - javascript
relatedPosts:
  postOne: content/posts/javascript/js-react-uno.mdx
  postTwo: content/posts/react/indice.mdx
  postThree: content/posts/react/intro.mdx
draft: false
featured: false
publishedAt: '2021-06-13T22:00:00.000Z'
---
...
> Puedes ver algunos pequeños tricks con `spread` [aquí](/blog/javascript/spread-tricks "")
...
> Puedes repasar todos los métodos de array más usados [aquí](/blog/javascript/array-methods "")
...
También puedes repasar la **primera parte** [aquí](/blog/javascript/js-react-uno "")
