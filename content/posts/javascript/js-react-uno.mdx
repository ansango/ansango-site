---
title: JavaScript para React - I
summary: >-
  Primera parte del resumen de las mejoras de ES6 más útiles para poder empezar
  a aprender React con soltura.
category: javascript
tags:
  options:
    - javascript
    - react
relatedPosts:
  postOne: content/posts/javascript/js-react-dos.mdx
...
Puedes continuar con la **segunda parte** [aquí](/blog/javascript/js-react-dos "")
