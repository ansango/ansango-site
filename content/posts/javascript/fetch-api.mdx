...
title: fetch API
summary: >-
  El pasado Ajax y el presente con Fetch API, un recorrido sobre como manejar
...
tags:
  options:
    ...
    - promises
relatedPosts:
  postOne: content/posts/javascript/ajax-async-await.mdx
draft: false
publishedAt: '2021-06-06T22:00:00.000Z'
---
