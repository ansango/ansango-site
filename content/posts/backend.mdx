---
title: Trabajar con backend y debug en React ⚛️
summary: Volver a hacer que funcione el maldito touchpad
bodyHighlight: true
...
> Puedes leer una guía completa acerca de `fetch API` <a href="/blog/javascript/fetch-api" target="_blank" rel="noopener noreferrer">aquí</a>
