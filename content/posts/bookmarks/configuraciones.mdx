---
title: "Configuraciones \U0001F516"
summary: >-
  Esta entrada de marcadores va a dedicarse sobre todo a recursos que tengan que
  ver con el sistema operativo, la terminal de comandos, navegadores, controles
  de versiones y repositorios, editores de código y plugins, herramientas para
  escribir código limpio y otras herramientas en general.
category: bookmarks
tags:
  options:
    - bookmarks
