...
Cualquiera puede olvidar cómo buscar espacios en blanco con regex, eliminar un elemento de un Array o hacer un bucle For. Esta hoja de trucos básicos, trata de proporcionar una referencia básica para nosotros, los desarrolladores.
