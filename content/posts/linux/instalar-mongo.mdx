---
title: Instalar MongoDB en Ubuntu 20.04
...
tags:
  options:
    ...
    - mongodb
relatedPosts:
  postOne: content/posts/linux/configurar-ubuntu.mdx
  postTwo: content/posts/linux/firefox-developer.mdx
draft: false
featured: false
...
1. **Verificar que MongoDB se ha iniciado**:
...
1. **Empezar a usar MongoDB**:

```powershell
mongo
```

1. **Arrancar la terminal de MongoDB**:
