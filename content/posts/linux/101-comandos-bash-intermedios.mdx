---
title: "Comandos Bash \U0001F4BB (Intermedios)"
...
lo que también originaría ese script .bashrc\_addl. Este archivo puede contener sus propios alias, funciones, variables de entorno, etc. Podría, a su vez, originar otros scripts, también. (¡Ten cuidado y evita los bucles infinitos de aprovisionamiento de scripts!)
...
`~/.bashrc_styles` - configuración estética, como PS1 y LS\_COLORS
