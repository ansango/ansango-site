---
title: Instalar Firefox Developer Edition en Ubuntu 20.04
summary: Cómo instalar Firefox Developer Edition y crear un acceso directo
draft: false
...
1. Descarga el archivo `.tar` de [Mozilla](https://www.mozilla.org/en-US/firefox/developer/). Ten en cuenta el nombre del archivo `.tar` porque cambia con cada actualización.
